                        ...
                        <div className="flex justify-between items-center w-full">
                            <div className="flex flex-wrap items-center">
                                {selectedValues.slice(0, maxCount).map((value) => {
                                    ...
                                    return (
                                        <Badge
                                            // variant="outline"
                                            key={value}
                                            className={cn(isAnimating ? "animate-bounce" : "") + ' py-[6px] rounded-xl mr-1'}
                                ...
                                {selectedValues.length > maxCount && (
                                    <Badge
                                        className={cn("bg-transparent text-foreground border-foreground/1 hover:bg-transparent", isAnimating ? "animate-bounce" : "")}
                                        style={{ animationDuration: `${animation}s` }}
                                    >
